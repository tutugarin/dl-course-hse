...
class TextDataset(Dataset):
    ...
    def __init__(self, data_file: str, train: bool = True, sp_model_prefix: str = None,
                 ...
                 model_type: str = 'bpe', max_length: int = 1024):
        """
    ...
    def __getitem__(self, item: int) -> Tuple[torch.Tensor, int]:
        ...
        indices.extend(self.indices[item])
        indices.append(self.eos_id)

        length = len(indices)

        indices.extend([self.pad_id] * (self.max_length - length))
